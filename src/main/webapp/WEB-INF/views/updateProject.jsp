...
<body>
	...
	<div class="project-div">
		<form:form class="project-form" action="../updateProject" method="post"
			...
			<div class="row g-3">
				...
				<option selected style="background-color:grey">${projectDto.status}</option>
			...
			<div class="allocated-resources">
				...
				<c:forEach items="${userList}" var="user">
					<tr>
						<td><form:checkbox path="users" class="form-check-input"
								id="chechbox" value="${ user}" />${user.userName}</td>
					</tr>
					<br>
				</c:forEach>
			</div>
